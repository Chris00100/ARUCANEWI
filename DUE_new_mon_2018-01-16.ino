...
double OWireOutsideTmp = 0;
double OWireHeatingTmp = 0;
double OWireEngineTmp = 0;
double OWireFridgeTmp = 0;
double DHT11MainCabinTmp = 0;
double DHT11OutsideHumidity = 0;
double BMP180AirPressure = 0;
...
void setup() {
Serial.begin(115200);
Serial.println("Start-up time 8 sec");
...
if ( DispUpdated+DispUpdatePeriod<millis() ) {
  ...
  if ( DispBlock > 10000 and DispBlock < 20000 ){
    ...
    lcd.setCursor(11, 0); lcd.print(PascalTomBar(BMP180AirPressure));
